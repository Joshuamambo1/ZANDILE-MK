    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            let message = mentionedUser
                ...
                : isGroup
                ? `${sender} is crying!`
                : `> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴇᴍᴏᴛɪᴏɴʟᴇss 𝙹𝚘𝚜𝚑𝚞𝚊𝚖𝚊𝚖𝚋𝚘𝟷 𝙽𝚎𝚝𝙺𝚒𝚗𝚐 🖤`;
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            let message = mentionedUser
                ...
                : `> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴇᴍᴏᴛɪᴏɴʟᴇss 𝙹𝚘𝚜𝚑𝚞𝚊𝚖𝚊𝚖𝚋𝚘𝟷 𝙽𝚎𝚝𝙺𝚒𝚗𝚐 😶‍🌫️💔`;
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            let message = mentionedUser
                ...
                : `> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝗠𝗜𝗟𝗗𝗥𝗘𝗗-𝗫𝗠𝗗 𝗡𝗘𝗧𝗞𝗜𝗡𝗚 🖤`;
    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            if (mentionedUser) {
                ...
                message = `> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝗠𝗜𝗟𝗗𝗥𝗘𝗗-𝗫𝗠𝗗 𝗡𝗘𝗧𝗞𝗜𝗡𝗚💔🫡💔`;
            }
