...
zandile({
    pattern: "netking",
    alias: "netking",
    desc: "Interact with ChatGPT using the MK Api.",
    category: "ai",
    react: "🤖",
    use: ".netking <your query>",
    filename: __filename,
    ...
    try {
        ...
        if (!response || !response.data || !response.data.result) {
            return reply("❌ No response received from the NetKing API. Please try again later.");
        }
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://files.catbox.moe/cik12y.jpg'; // Remplacez par l'URL de votre image AI
...
malvin({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/jog59s.jpg'; // Replace with a valid image URL
